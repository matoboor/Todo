...
<asp:Content runat="server" ContentPlaceHolderID="main">
    ...
    <asp:Button ID="DeleteButton" runat="server" OnClick="DeleteButton_Click" Text="Delete Project" />
    <p> 
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="TasksDataSource" CellPadding="5" CellSpacing="10" DataKeyNames="Id" ForeColor="White" ShowFooter="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            ...
            <Columns>
                <asp:TemplateField ShowHeader="False">
                    ...
                    <FooterTemplate>
                        <asp:Button ID="AddTask" runat="server" OnClick="AddTask_Click" Text="New" />
                    </FooterTemplate>
                </asp:TemplateField>
            ...
            <EmptyDataTemplate>
                <div>
                    <asp:Button ID="FirstTaskButton" runat="server" OnClick="FirstTaskButton_Click" Text="Add new task" />
                </div>
            </EmptyDataTemplate>
...
<asp:Content runat="server" ContentPlaceHolderID="aside">
    ...
    <div>
    <asp:TextBox ID="newProject" runat="server" Width="100px" ValidationGroup="0"></asp:TextBox>
    <asp:Button ID="newProjectButton" runat="server" OnClick="newProjectButton_Click" Text="Add" ValidationGroup="0" />
